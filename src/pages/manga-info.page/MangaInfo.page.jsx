...
import { GET_MANGA_PAGE } from "../../queries/mangaQueries";

const AnimeInfo = () => {
    const { id } = useParams();

    const { loading, error, data } = useQuery(GET_MANGA_PAGE, {
        variables: { id: id },
    });
        ...
        <>
            ...
            <div className="info-page">
                <div className="small-info">
                    ...
                    <p>chapters : {data.Media.chapters}</p>
                    <p>volumes : {data.Media.volumes}</p>
